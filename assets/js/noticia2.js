        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (var i = 0; i < posts.length; i++) {
                ...
                if (postId === id) {
                    ...
                    var conteudo = conteudoCompleto.slice(0, limiteDeCaracteres);
                    var conteudoContinuacao = conteudoCompleto.slice(limiteDeCaracteres);
                    document.querySelector(".adicionar-conteudo-noticia").innerHTML = conteudoCompleto;
                    // Exibe os primeiros 300 caracteres do conteúdo na primeira tag <p>
                    // document.getElementById("conteudo").innerText = conteudo;

                    // Exibe o restante do conteúdo na segunda tag <p>
